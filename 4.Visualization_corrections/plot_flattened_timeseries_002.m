...
nrepetitions = 340;
m = load('/Users/francisca/Documents/Data/20180717_120447_CL_180718_visualstim_FFF_1_1/11/Masks/all.mat');
mask = m;
...
for i = 1:nrepetitions
    V_im            =   spm_vol(['/Users/francisca/Documents/Data/' study_folder '/' num2str(scan_folder) '/' other_folder '/' 'Image_' num2str(scan_folder) '_' num2str(i,'%04d') '.nii']);
...
clear flat1
flat1               =   flat;
flat1               =   myregress2([r0;r1],flat,~~tmask); 
