...
study_folder = {'/Users/francisca/Documents/Data/20180818_182309_FFF_etomidate3rdform_1_1'};
scan_folder = [11,14:20];
masking_folder = [11,14:20];
    ...
    for s = 1:no_folders(f)
        ...
        for i = 1:nrepetitions
            if strcmp(name_of_mask,'brain_mask')
                if after_correction
                    ...
                    file = [input_folder  filesep 'Image_' num2str(i,'%04d') '.nii'];
                end
        ...
        for sl = which'
            ...
            while continuing
                ...
                if length(unique([to_correct points]))==length(to_correct)
                    continuing=0;
                else
                    to_correct=unique([to_correct points]);
